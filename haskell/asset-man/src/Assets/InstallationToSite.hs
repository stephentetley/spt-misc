...
type TransformAibS4 ctx a b = Transform ctx TranslateM a b


applyTransform :: RulesEnv -> TransformAibS4 Ctx0 a b -> a -> Either String b
...
liftTranslate :: TranslateM b -> TransformAibS4 ctx a b
liftTranslate = constT


installationToSite :: TransformAibS4 Ctx0 AibInstallation S4.S4Site
installationToSite = installation


installation :: TransformAibS4 Ctx0 AibInstallation S4.S4Site
...
installationKid :: TransformAibS4 Ctx1 AibInstallationKid S4.S4Function
installationKid = 
    installationKid_ProcessGroup 
        <+ installationKid_Process 
        <+ catchall

installationKid_ProcessGroup :: TransformAibS4 Ctx1 AibInstallationKid S4.S4Function      
...
installationKid_Process :: TransformAibS4 Ctx1 AibInstallationKid S4.S4Function  
...
catchall :: TransformAibS4 Ctx1 AibInstallationKid S4.S4Function  
...
processGroup :: TransformAibS4 Ctx1 AibProcessGroup S4.S4ProcessGroup
...
processGroupKid :: TransformAibS4 Ctx2 AibProcessGroupKid S4.S4Process
processGroupKid = processGroupKid_Process
    
processGroupKid_Process :: TransformAibS4 Ctx2 AibProcessGroupKid S4.S4Process
processGroupKid_Process = 
    aibProcessGroupKid_ProcessT process (\a -> a)

process :: TransformAibS4 Ctx2 AibProcess S4.S4Process
